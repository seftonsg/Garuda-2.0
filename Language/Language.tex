...
\subsection{Standard Taint}
  ...
  \begin{array}{r c l}
    ...
    \mathsf{PropTaintALU} &\triangleq&
      %% is this really an injection of an instruction, or directly changing part of the op code?
      %% Can garuda automatically determine between "inject(instruction)" and "inject(change Instruction Field)"
      %% This becomes a mutate, rather than an injection, doesn't it?  Intermediate should take care of that
