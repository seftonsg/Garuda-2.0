...
\section{Semantics}
 %{\fontsize{12pt}{14pt}\selectfont
    ...
    \begin{align*}
        ...
        %Stall
        %% Would this be done better with a map of some sort?
        %% Could this just be implemented as inject_i(0) with some sort of loop?
        %% Therefore, no stall instr, just an ability to loop?  Do we just bring
